...
def generate_launch_description():
    ...
    print("hobot_centerpoint path is ", pkg_path)
    ...
    config_file_launch_arg = DeclareLaunchArgument(
        "config_file", default_value=TextSubstitution(text=pkg_path+"/config/centerpoint_pointpillar_nuscenes/workflow_latency.json")
    )
